<template>
  <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules">
    ...
    <el-form-item style="width: 100%">
      <el-button :loading="loading" class="signup-btn" type="success" @click="signup">注册</el-button>
    </el-form-item>
      ...
      await axios.get(
        ...
        .then(res => {
          ...
          if (res.data.type === "student") {
            ...
            Cookies.set('student_id', res.data.id, { expires: 7, sameSite: 'Lax' })
            ElNotification({
              title: '登录成功',
            ...
            Cookies.set('teacher_id', res.data.id, { expires: 7, sameSite: 'Lax' })
            router.push({
              path: '/TeacherHome',
            })
            ElNotification({
